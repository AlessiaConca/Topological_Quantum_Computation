...
Let's briefly analyze the statistics of $e$-particles in the context of the ground state, \textit{as exemplified in \cite{Rao16}}. If we take a simple string operator $\sigma^z|GS\rangle$ , where $|GS\rangle$ denotes the ground state, it creates two $e$-particles in the vertices adjacent to the edge as shown in figure 1.11. \newline 
