...
\begin{document}
	\begin{tikzpicture}
		...
		\foreach \i in {-2,...,-2}
		{
			\draw[black!50, line width=1.5mm] (\i,-1) -- (\i,1.5);
			\node[draw, circle, fill=black!50] at (\i,-0.5) {};
			\node[draw, circle, fill=black!50] at (\i,0.5) {};
			
			\draw[black!50, line width=1.5mm] (\i,1) -- (\i,2);
			\node[draw, circle, fill=black!50] at (\i,1.5) {};
		...
		\foreach \j in {2,...,2}
		{
			...
			\draw[black!50, line width=1.5mm] (-1.5, \j) -- (1, \j);
			\draw node[draw,circle,fill=black!50] at (-0.5,\j) {};
			\draw node[draw,circle,fill=black!50] at (0.5,\j) {};
			\draw node[draw,circle,fill=black!50] at (-1.5,\j) {};
		...
		\foreach \i in {1,...,1}
		{
			...
			\node[draw, circle, fill=black!50] at (\i,-0.5) {};
			\node[draw, circle, fill=black!50] at (\i,0.5) {};
			\draw node[draw,circle,fill=black!50] at (\i,1.5) {};
			
		}
		
		\foreach \j in {-1,...,-1}
		{
			\draw[black!50, line width=1.5mm] (-2, \j) -- (1, \j);
			\draw node[draw,circle,fill=black!50] at (0.5,\j) {};
			\draw node[draw,circle,fill=black!50] at (-0.5,\j) {};
			\draw node[draw,circle,fill=black!50] at (-1.5,\j) {};
		}
		...
		\foreach \i in {2,...,2}
		{
			\draw[black!50, line width=1.5mm] (\i,-3) -- (\i,3);
			\node[draw, circle, fill=black!50] at (\i,2.5) {};
			\node[draw, circle, fill=black!50] at (\i,0.5) {};
			\draw node[draw,circle,fill=black!50] at (\i,1.5) {};
			\node[draw, circle, fill=black!50] at (\i,-0.5) {};
			\draw node[draw,circle,fill=black!50] at (\i,-1.5) {};
			\draw node[draw,circle,fill=black!50] at (\i,-2.5) {};
