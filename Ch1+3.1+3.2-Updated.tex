	...
	\begin{center}
		\begin{tikzpicture}
			...
			\foreach \j in {1,...,1}
			{
				...
				\node[draw, circle, fill=blue!80,label=center:\textbf{Z}, label=right:\textbf{\large $-1$}] at (0.5,\j) {};
				\node[draw, circle, fill=blue!80,label=center:\textbf{Z}] at (-0.5,\j) {};
				\node[draw, circle, fill=blue!80,label=center:\textbf{Z}, label=right:\textbf{\large $-1$}] at (-1.5,\j) {};
