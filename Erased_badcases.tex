	...
	\begin{center}
		\begin{tikzpicture}
			...
			\foreach \j in {1.2,...,1.2}
			{
				...
				\draw[orange, line width=1.5mm] (0, \j) -- (2, \j);
			...
			\foreach \i in {0,...,0}
			{
				...
				\draw[orange, line width=1.5mm] (\i,0) -- (\i, 1.2 );
				...
				\foreach \j in {-2,...,-2}
			{
				...
				\draw[orange, line width=1.5mm] (-2,\j) -- (-1,\j);
				...
				\foreach \i in {1,...,1}
			{
				...
				\draw[orange, line width=1.5mm] (\i,-2.2) -- (\i, -1 );
			...
			\foreach \j in {-2.2,...,-2.2}
			{
				...
				\draw[orange, line width=1.5mm] (1, \j) -- (2, \j);
