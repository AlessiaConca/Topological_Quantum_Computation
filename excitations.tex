	...
	\begin{center}
		...
		\begin{tikzpicture}
			...
			\foreach \i in {-2,...,-2}
			{
				...
				\draw[red!80, line width=1.5mm] (\i,-0.5) -- (\i,1.5);
				\draw[red!30, line width=1.5mm] (\i,1.5) -- (\i,2);
				\node[draw, circle, fill=red!80,label=center:\textbf{X},label=south:\textbf{\large \bf $e$}] at (\i,-0.5) {};
				\node[draw, circle, fill=red!80,label=center:\textbf{X}] at (\i,0.5) {};
				\node[draw, circle, fill=red!80,label=center:\textbf{X},label=north:\textbf{\bf \large $e$}] at (\i,1.5) {};
			...
			\foreach \j in {-1.5,...,-1.5}
			{
				...
				\draw node[draw,circle,fill=blue!50,label=center:\textbf{Z},label=left:\textbf{\large \bf $m$}] at (1,\j) {};
				\draw node[draw,circle,fill=blue!50,label=center:\textbf{Z},label=right:\textbf{\large \bf $m$}] at (2,\j) {};
