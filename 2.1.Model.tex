...
\begin{document}
	...
	\begin{minipage}{1\textwidth}
		...
		Given definition 2.1.4, we can now write the Hamiltonian of the whole system as follows:\newline
		
		\textbf{Definition 2.1.3.} (Toric Code Hamiltonian) Given the application sites v and p of  respectively, vertex and plaquette operators, and given spin-$\frac{1}{2}$ particles located on each edge of the torus, we can define the following Hamiltonian for the system\newline
