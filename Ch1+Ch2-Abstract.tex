...
As a consequence, quantum error correction has emerged as an important area of research. Traditional error correction techniques developed for classical computers cannot be directly applied to quantum systems due to the intrinsic fragility of quantum information. Quantum error correction goal is to mitigate errors by encoding quantum information into carefully designed quantum states.\newline
Several quantum computing models are being studied theoretically
in order to give access to their practical realizations. 
Among various quantum error-correcting codes, topological codes are of particular interest due to their robustness against local errors and their ability to encode information in a non-local manner. The toric code, proposed by A. Kitaev, stands as a promising example of a topological code. The toric code exhibits topological order and anyonic excitations. These two features make it a well-suited candidate for fault-tolerant quantum computation. \newline
